...
def run(submit=False, specific_jobs=None, condor_q=None):
    ...
    output_path = "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp/Full2022EEv12/rootFiles/ttDM_2022EE/"
    jobDir = path
    ...
    for fname in fnames:
        file_name = output_path + "mkShapes__ttDM_2022EE__ALL__" + fname + ".root"
