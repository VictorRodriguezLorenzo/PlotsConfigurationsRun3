...
# DATA FROM RUN 3
#files_WW = nanoGetSampleFiles(mcDirectory, 'WWTo2L2Nu') + nanoGetSampleFiles(mcDirectory, 'WWTo2L2Nu')

#files_WWewk = nanoGetSampleFiles(mcDirectory, 'WpWmJJ_EWK') + nanoGetSampleFiles(mcDirectory, 'WpWmJJ_EWK')
