...
# Load the model
model = load_model('/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp/Full2022v12/DNNmodels/Models/model_dnn_model_DNN_.h5', compile = False)
