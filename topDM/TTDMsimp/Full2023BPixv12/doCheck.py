...
def run(submit=False, specific_jobs=None, condor_q=None):
    ...
    output_path = "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp/Full2023BPixv12/rootFiles/ttDM_2023BPix/"
    jobDir = path
    ...
    for fname in fnames:
        file_name = output_path + "mkShapes__ttDM_2023BPix__ALL__" + fname + ".root"
