...
# Load the model
model = load_model('/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2022EEv12/DNNmodels/Models/model_dnn_model.keras', compile = False)
