...
btag_eff_file = 'bTagEff_Full2022EEv12_ttbar_PNetB_medium.root'
...
features_ttDM = [v for v in joblib.load(
    "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2022EEv12/DNNmodels/Models/features_model_DNN_ttDM_ps.pkl"
) if v != 'mPhi']
...
aliases['evaluate_dnn_ttDM_ps'] = {
    'linesToAdd': [
        '#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2022EEv12/evaluate_DNN_ttDM.cc"'
    ],
...
features_ttDM = [v for v in joblib.load(
    "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2022EEv12/DNNmodels/Models/features_model_DNN_ttDM_s.pkl"
) if v != 'mPhi']
...
features_tWDM = [v for v in joblib.load(
    "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2022EEv12/DNNmodels/Models/features_model_DNN_tWDM_ps.pkl"
) if v != 'mPhi']
...
aliases['evaluate_dnn_tWDM_ps'] = {
    'linesToAdd': [
        '#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2022EEv12/evaluate_DNN_tWDM.cc"'
    ],
...
features_tWDM = [v for v in joblib.load(
    "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2022EEv12/DNNmodels/Models/features_model_DNN_tWDM_s.pkl"
) if v != 'mPhi']
