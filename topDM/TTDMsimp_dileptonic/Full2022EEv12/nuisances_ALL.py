...
import sys
sys.path.insert(0, "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2022EEv12")
from theoryNormalizations_2022EE import theoryNormalizations as TheoryNormalizations
