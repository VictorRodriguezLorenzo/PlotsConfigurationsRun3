...
def objective(trial):
    ...
    train_gen = balanced_batch_generator(X_train_scaled, y_train, batch_size=hp["batch_size"])
    steps_per_epoch = len(X_train_scaled) // hp["batch_size"]
    ...
    trial.set_user_attr("layer_sizes","-".join(map(str,hp["layer_sizes"])))
