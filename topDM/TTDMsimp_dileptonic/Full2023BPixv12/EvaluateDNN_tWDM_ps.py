...
MODEL_DIR = "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023BPixv12/DNNmodels/Models"

# Load the model
model = load_model(
    f"{MODEL_DIR}/model_DNN_tWDM_ps.keras",
    custom_objects={"AffineConditioning": AffineConditioning},
    compile=False,
)

# Load scaler
scaler = joblib.load(f"{MODEL_DIR}/scaler_model_DNN_tWDM_ps.pkl")
