...
def run(submit=False, specific_jobs=None, condor_q=None, tag=tag):
    ...
    fnames = [
        fname.decode("ascii").split(f"/{tag}/")[1]
        for fname in fnames
    ]
...
transfer_input_files = $(Folder)/script.py, /afs/cern.ch/user/v/victorr/private/mkShapesRDF/mkShapesRDF/include/headers.hh, /afs/cern.ch/user/v/victorr/private/mkShapesRDF/mkShapesRDF/shapeAnalysis/runner.py, /afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023BPixv12/configs/config.json
