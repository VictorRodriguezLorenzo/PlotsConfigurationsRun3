...
)
{
    ...
    if (pFunctionAll == nullptr) {
        ...
        PyList_Append(sysPath, PyUnicode_DecodeFSDefault("/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023BPixv12"));

	std::string moduleName = "EvaluateDNN_ttDM_" + model_type;
