...
aliases['fakeW'] = {
    ...
    'linesToProcess':["ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader = fake_rate_reader(\"2023\", \"Run3\", \"67\", \"nominal\", 2, \"std\");')"],
...
aliases['fakeWEleUp'] = {
    ...
    'linesToProcess':["ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader_EleUp = fake_rate_reader(\"2023\", \"Run3\", \"67\", \"EleUp\", 2, \"std\");')"],
...
aliases['fakeWEleDown'] = {
    'linesToAdd' : ['#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader_EleDown = fake_rate_reader(\"2023\", \"Run3\", \"67\", \"EleDown\", 2, \"std\");')"],
...
aliases['fakeWMuUp'] = {
    'linesToAdd' : ['#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader_MuUp = fake_rate_reader(\"2023\", \"Run3\", \"67\", \"MuUp\", 2, \"std\");')"],
...
aliases['fakeWMuDown'] = {
    'linesToAdd' : ['#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader_MuDown = fake_rate_reader(\"2023\", \"Run3\", \"67\", \"MuDown\", 2, \"std\");')"],
...
aliases['fakeWStatEleUp'] = {
    'linesToAdd' : ['#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader_StatEleUp = fake_rate_reader(\"2023\", \"Run3\", \"67\", \"StatEleUp\", 2, \"std\");')"],
...
aliases['fakeWStatEleDown'] = {
    'linesToAdd' : ['#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader_StatEleDown = fake_rate_reader(\"2023\", \"Run3\", \"67\", \"StatEleDown\", 2, \"std\");')"],
...
aliases['fakeWStatMuUp'] = {
    'linesToAdd' : ['#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader_StatMuUp = fake_rate_reader(\"2023\", \"Run3\", \"67\", \"StatMuUp\", 2, \"std\");')"],
...
aliases['fakeWStatMuDown'] = {
    'linesToAdd' : ['#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader_StatMuDown = fake_rate_reader(\"2023\", \"Run3\", \"67\", \"StatMuDown\", 2, \"std\");')"],
...
year = '2023_Summer23'
btag_eff_file = 'bTagEff_Full2023v12_ttbar_PNetB_medium.root'
...
features_ttDM = [v for v in joblib.load(
    "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023v12/DNNmodels/Models/features_model_DNN_ttDM_ps.pkl"
) if v != 'mPhi']
...
aliases['evaluate_dnn_ttDM_ps'] = {
    'linesToAdd': [
        '#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023v12/evaluate_DNN_ttDM.cc"'
    ],
...
features_ttDM = [v for v in joblib.load(
    "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023v12/DNNmodels/Models/features_model_DNN_ttDM_s.pkl"
) if v != 'mPhi']
...
features_tWDM = [v for v in joblib.load(
    "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023v12/DNNmodels/Models/features_model_DNN_tWDM_ps.pkl"
) if v != 'mPhi']
...
aliases['evaluate_dnn_tWDM_ps'] = {
    'linesToAdd': [
        '#include "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023v12/evaluate_DNN_tWDM.cc"'
    ],
...
features_tWDM = [v for v in joblib.load(
    "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023v12/DNNmodels/Models/features_model_DNN_tWDM_s.pkl"
) if v != 'mPhi']
