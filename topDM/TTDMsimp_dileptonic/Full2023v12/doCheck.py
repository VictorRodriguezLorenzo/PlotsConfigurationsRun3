...
def run(submit=False, specific_jobs=None, condor_q=None):
    ...
    path = prePath + "/condor/EGamma1_Run2023C-Prompt-v4/"
    output_path = "/eos/user/v/victorr/www/Run3-ttDM/rootFiles/ttDM_dilep_2023/"
    #output_path = "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_dileptonic/Full2023v12/rootFiles/ttDM_dilep_2023/"
    jobDir = path
    ...
    fnames = [
        fname.decode('ascii').split("EGamma1_Run2023C-Prompt-v4/")[1]
        for fname in fnames
    ]
    ...
    for fname in fnames:
        ...
        file_name = output_path + "mkShapes__ttDM_dilep_2023__ALL__" + fname + ".root"
