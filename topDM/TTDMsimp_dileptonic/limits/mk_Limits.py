...
input datacard directory (default: ``${CAMPAIGN}/datacards``):
  ...
  * ``DYCR1b``: ``datacards/dycr_1b/events``
  * ``DYCR2b``: ``datacards/dycr_2b/events``
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--condor-runtime", type=int, default=100000, help="Condor RequestRuntime")
