...
aliases['nForwardjets'] = {
    'expr': 'Sum(CleanJet_pt > 20. && CleanJet_eta > 2.5) '
}
...
for flavour in ['bc', 'light']:
    ...
    aliases[btagsf_tmp] = {
        'linesToProcess':[
            ...
            f"ROOT.gInterpreter.Declare('btagSF{flavour} btag_SF{flavour} = btagSF{flavour}(\"/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_semileptonic/data/btag_eff/bTagEff_2022_ttbar_loose.root\",\"{year}\",\"_parT\");')"
        ],
