...
def run(submit=False, specific_jobs=None, condor_q=None):
    ...
    output_path = "/afs/cern.ch/user/v/victorr/private/PlotsConfigurationsRun3/topDM/TTDMsimp_semileptonic/Full2022v12/rootFiles/ttDM_semilep_2022/"
    jobDir = path
    ...
    for fname in fnames:
        file_name = output_path + "mkShapes__ttDM_semilep_2022__ALL__" + fname + ".root"
